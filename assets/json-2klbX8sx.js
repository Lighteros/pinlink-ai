import { m as Be } from "./index-BV35e4bv.js";
import { r as Tt } from "./___vite-browser-external_commonjs-proxy-Bd4FGpDG.js";
var Lt = {},
  Ke = {},
  Ue = {},
  et;
  ...
  return (
    nt ||
      ...
      (function (t) {
        Object.defineProperty(t, "__esModule", { value: !0 });
        const r = Be;
        r.__exportStar(Bt(), t), r.__exportStar(xt(), t);
      })($e)),
    $e
  );
}
  ...
  return (
    at ||
      ...
      (function (t) {
        Object.defineProperty(t, "__esModule", { value: !0 });
        const r = Be;
        r.__exportStar(Mt(), t), r.__exportStar(jt(), t);
      })(Ke)),
    Ke
  );
}
...
function It() {
  ...
  class t {
    ...
    stop(n) {
      ...
      this.timestamps.set(n, { started: f.started, elapsed: w });
    }
    get(n) {
      const f = this.timestamps.get(n);
      if (typeof f > "u") throw new Error(`No timestamp found for label: ${n}`);
      return f;
    }
    elapsed(n) {
      const f = this.get(n);
  ...
  return (Ce.Watch = t), (Ce.default = t), Ce;
}
var ze = {},
  Oe = {},
  ot;
...
function pe(t) {
  const r = Se(t);
  if (!r) throw new Error(`${t} is not defined in Window`);
  return r;
}
...
function tr() {
  let t, r;
  try {
    (t = ht.getDocumentOrThrow()), (r = ht.getLocationOrThrow());
  } catch {
    return null;
  }
  function n() {
  ...
  function f(...E) {
    ...
    for (let _ = 0; _ < b.length; _++) {
      const v = b[_],
        C = ["itemprop", "property", "name"]
          .map((g) => v.getAttribute(g))
  ...
  const U = w(),
    ...
    c = r.origin,
    d = n();
  return { description: h, url: c, icons: d, name: U };
}
...
function ir(t) {
  try {
    ...
    for (var r = t.match(st) || [], n = 1; n < r.length; n++)
      (t = Ye(r, n).join("")), (r = t.match(st) || []);
    return t;
  }
}
function ar(t) {
  for (var r = { "%FE%FF": "��", "%FF%FE": "��" }, n = ct.exec(t); n; ) {
    try {
...
var ur = function (t) {
  ...
  fr = function (t, r) {
    for (
      var n = {}, f = Object.keys(t), w = Array.isArray(r), S = 0;
      S < f.length;
      S++
    ) {
      var U = f[S],
...
(function (t) {
        ...
        return (a) => (o, u) =>
          ...
          (s.skipEmptyString && u === "")
            ...
            : ((u = u === null ? "" : u),
              o.length === 0
                ? [[l(a, s), D, l(u, s)].join("")]
                : [[o, l(u, s)].join(s.arrayFormatSeparator)]);
      }
      default:
        return (D) => (a, o) =>
          o === void 0 ||
  ...
  function c(s) {
    ...
    switch (s.arrayFormat) {
      case "index":
        return (a, o, u) => {
          if (
            ((D = /\[(\d*)\]$/.exec(a)), (a = a.replace(/\[\d*\]$/, "")), !D)
          ) {
            u[a] = o;
            return;
          }
          u[a] === void 0 && (u[a] = {}), (u[a][D[1]] = o);
        };
      case "bracket":
        return (a, o, u) => {
          if (((D = /(\[\])$/.exec(a)), (a = a.replace(/\[\]$/, "")), !D)) {
            u[a] = o;
            return;
          }
          if (u[a] === void 0) {
      ...
      case "colon-list-separator":
        return (a, o, u) => {
          if (((D = /(:list)$/.exec(a)), (a = a.replace(/:list$/, "")), !D)) {
            u[a] = o;
            return;
          }
          if (u[a] === void 0) {
        ...
        return (a, o, u) => {
          const e = typeof o == "string" && o.includes(s.arrayFormatSeparator),
            i =
              typeof o == "string" &&
              !e &&
              E(o, s).includes(s.arrayFormatSeparator);
          o = i ? E(o, s) : o;
          const y =
            e || i
              ? o.split(s.arrayFormatSeparator).map((p) => E(p, s))
              : o === null
              ? o
              : E(o, s);
          u[a] = y;
      ...
      case "bracket-separator":
        return (a, o, u) => {
          ...
          const i =
            o === null
              ? []
              : o.split(s.arrayFormatSeparator).map((y) => E(y, s));
          if (u[a] === void 0) {
            u[a] = i;
            return;
          }
  ...
  function _(s) {
    const D = s.indexOf("#");
    return D !== -1 && (s = s.slice(0, D)), s;
  }
  function v(s) {
    let D = "";
    const a = s.indexOf("#");
    return a !== -1 && (D = s.slice(a)), D;
  }
  function C(s) {
    s = _(s);
    const D = s.indexOf("?");
  ...
  function O(s, D) {
    ...
    for (const u of Object.keys(o)) {
      ...
      if (typeof e == "object" && e !== null)
        for (const i of Object.keys(e)) e[i] = g(e[i], D);
      else o[u] = g(e, D);
    }
    return D.sort === !1
      ? o
  ...
  (t.extract = C),
    ...
    (t.stringify = (s, D) => {
      ...
      (D = Object.assign(
        ...
        d(D.arrayFormatSeparator);
      const a = (i) =>
          (D.skipNull && S(s[i])) || (D.skipEmptyString && s[i] === ""),
        o = h(D),
        u = {};
      for (const i of Object.keys(s)) a(i) || (u[i] = s[i]);
      const e = Object.keys(u);
      return (
        D.sort !== !1 && e.sort(D.sort),
        e
          .map((i) => {
            const y = s[i];
            return y === void 0
              ...
              ? l(i, D)
              : Array.isArray(y)
              ? y.length === 0 && D.arrayFormat === "bracket-separator"
                ? l(i, D) + "[]"
                : y.reduce(o(i), []).join("&")
              : l(i, D) + "=" + l(y, D);
          })
    ...
    (t.stringifyUrl = (s, D) => {
      D = Object.assign({ encode: !0, strict: !0, [U]: !0 }, D);
      ...
      return (
        s.fragmentIdentifier &&
          (y = `#${D[U] ? l(s.fragmentIdentifier, D) : s.fragmentIdentifier}`),
        `${a}${i}${y}`
      );
    }),
    (t.pick = (s, D, a) => {
      a = Object.assign({ parseFragmentIdentifier: !0, [U]: !1 }, a);
      const { url: o, query: u, fragmentIdentifier: e } = t.parseUrl(s, a);
      return t.stringifyUrl(
        { url: o, query: w(u, D), fragmentIdentifier: e },
        a
      );
    }),
    (t.exclude = (s, D, a) => {
...
(function (t) {
  ...
  (t.isInteger = Number.isInteger || U),
    ...
    (t.isSafeInteger = function (h) {
      return (
        t.isInteger(h) && h >= -t.MAX_SAFE_INTEGER && h <= t.MAX_SAFE_INTEGER
      );
    });
})(bt);
...
var wt = bt;
function sr(t, r) {
  return r === void 0 && (r = 0), (((t[r + 0] << 8) | t[r + 1]) << 16) >> 16;
}
x.readInt16BE = sr;
function cr(t, r) {
  return r === void 0 && (r = 0), ((t[r + 0] << 8) | t[r + 1]) >>> 0;
}
x.readUint16BE = cr;
function Dr(t, r) {
  return r === void 0 && (r = 0), (((t[r + 1] << 8) | t[r]) << 16) >> 16;
}
x.readInt16LE = Dr;
function lr(t, r) {
  return r === void 0 && (r = 0), ((t[r + 1] << 8) | t[r]) >>> 0;
}
x.readUint16LE = lr;
function vt(t, r, n) {
  return (
    r === void 0 && (r = new Uint8Array(2)),
    n === void 0 && (n = 0),
    (r[n + 0] = t >>> 8),
    (r[n + 1] = t >>> 0),
    r
...
function vr(t, r, n) {
  ...
  for (var f = 0, w = 1, S = n; S < n + t / 8; S++) (f += r[S] * w), (w *= 256);
  return f;
}
x.readUintLE = vr;
function gr(t, r, n, f) {
...
function yr(t, r, n, f) {
  ...
  for (var w = 1, S = f; S < f + t / 8; S++) (n[S] = (r / w) & 255), (w *= 256);
  return n;
}
x.writeUintLE = yr;
function Sr(t, r) {
...
function Ar(t, r, n) {
  ...
  return f.setFloat32(n, t), r;
}
x.writeFloat32BE = Ar;
function Ur(t, r, n) {
  r === void 0 && (r = new Uint8Array(4)), n === void 0 && (n = 0);
  var f = new DataView(r.buffer, r.byteOffset, r.byteLength);
  return f.setFloat32(n, t, !0), r;
}
x.writeFloat32LE = Ur;
function Or(t, r, n) {
  r === void 0 && (r = new Uint8Array(8)), n === void 0 && (n = 0);
  var f = new DataView(r.buffer, r.byteOffset, r.byteLength);
  return f.setFloat64(n, t), r;
}
x.writeFloat64BE = Or;
function Fr(t, r, n) {
  r === void 0 && (r = new Uint8Array(8)), n === void 0 && (n = 0);
  var f = new DataView(r.buffer, r.byteOffset, r.byteLength);
  return f.setFloat64(n, t, !0), r;
}
x.writeFloat64LE = Fr;
var Ee = {};
...
function Lr(t, r, n) {
  for (
    var f = 1634760805,
      ...
      S = 2036477234,
      U = 1797285236,
      h = (n[3] << 24) | (n[2] << 16) | (n[1] << 8) | n[0],
      c = (n[7] << 24) | (n[6] << 16) | (n[5] << 8) | n[4],
      d = (n[11] << 24) | (n[10] << 16) | (n[9] << 8) | n[8],
      l = (n[15] << 24) | (n[14] << 16) | (n[13] << 8) | n[12],
      E = (n[19] << 24) | (n[18] << 16) | (n[17] << 8) | n[16],
      b = (n[23] << 24) | (n[22] << 16) | (n[21] << 8) | n[20],
      _ = (n[27] << 24) | (n[26] << 16) | (n[25] << 8) | n[24],
      v = (n[31] << 24) | (n[30] << 16) | (n[29] << 8) | n[28],
...
function mt(t, r, n, f, w) {
  ...
  if (w === 0) {
    ...
    (S = new Uint8Array(16)), (U = S.length - r.length), S.set(r, U);
  } else {
    if (r.length !== 16)
  ...
  for (var h = new Uint8Array(64), c = 0; c < n.length; c += 64) {
    Lr(h, S, t);
    for (var d = c; d < c + 64 && d < n.length; d++) f[d] = n[d] ^ h[d - c];
    Br(S, 0, U);
  }
  return Je.wipe(h), w === 0 && Je.wipe(S), f;
}
xe.streamXOR = mt;
function Mr(t, r, n, f) {
  return f === void 0 && (f = 0), Je.wipe(n), mt(t, r, n, n, f);
}
xe.stream = Mr;
function Br(t, r, n) {
  for (var f = 1; n--; )
    (f = (f + (t[r] & 255)) | 0), (t[r] = f & 255), (f >>>= 8), r++;
  if (f > 0) throw new Error("ChaCha: counter overflow");
}
var Ct = {},
  we = {};
...
function pt(t, r) {
  ...
  for (var n = 0, f = 0; f < t.length; f++) n |= t[f] ^ r[f];
  return 1 & ((n - 1) >>> 8);
}
we.compare = pt;
function Rr(t, r) {
...
(function (t) {
  ...
  var f = (function () {
    ...
    return (
      (U.prototype._blocks = function (h, c, d) {
        for (
      ...
      (U.prototype.finish = function (h, c) {
        ...
        for (l = this._h[1] >>> 13, this._h[1] &= 8191, _ = 2; _ < 10; _++)
          (this._h[_] += l), (l = this._h[_] >>> 13), (this._h[_] &= 8191);
        for (
          this._h[0] += l * 5,
            l = this._h[0] >>> 13,
            this._h[0] &= 8191,
          ...
          (d[_] = this._h[_] + l), (l = d[_] >>> 13), (d[_] &= 8191);
        for (d[9] -= 8192, E = (l ^ 1) - 1, _ = 0; _ < 10; _++) d[_] &= E;
        for (E = ~E, _ = 0; _ < 10; _++) this._h[_] = (this._h[_] & E) | d[_];
        for (
      ...
      (U.prototype.update = function (h) {
        var c = 0,
          ...
          l;
        if (this._leftover) {
          (l = 16 - this._leftover), l > d && (l = d);
          for (var E = 0; E < l; E++)
            this._buffer[this._leftover + E] = h[c + E];
          if (((d -= l), (c += l), (this._leftover += l), this._leftover < 16))
            return this;
          this._blocks(this._buffer, 0, 16), (this._leftover = 0);
        }
        if (
          (d >= 16 &&
            ((l = d - (d % 16)), this._blocks(h, c, l), (c += l), (d -= l)),
          d)
        ) {
          for (var E = 0; E < d; E++)
            this._buffer[this._leftover + E] = h[c + E];
  ...
  t.oneTimeAuth = w;
  function S(U, h) {
    return U.length !== t.DIGEST_LENGTH || h.length !== t.DIGEST_LENGTH
      ? !1
      : r.equal(U, h);
  }
  t.equal = S;
...
(function (t) {
  ...
  var U = new Uint8Array(16),
    h = (function () {
      ...
      return (
        (c.prototype.seal = function (d, l, E, b) {
          if (d.length > 16)
          ...
          var C = l.length + this.tagLength,
            g;
          if (b) {
            if (b.length !== C)
              throw new Error("ChaCha20Poly1305: incorrect destination length");
            g = b;
          } else g = new Uint8Array(C);
          return (
            r.streamXOR(this._key, _, l, g, 4),
            this._authenticate(
        ...
        (c.prototype._authenticate = function (d, l, E, b) {
          ...
          b && w.writeUint64LE(b.length, v),
            ...
            _.update(v);
          for (var C = _.digest(), g = 0; g < C.length; g++) d[g] = C[g];
          _.clean(), f.wipe(C), f.wipe(v);
        }),
        c
      );
    })();
  ...
  Ut = (function () {
    function t(r, n) {
      ...
      n.length > this.blockSize
        ? this._inner.update(n).finish(f).clean()
        : f.set(n);
      for (var w = 0; w < f.length; w++) f[w] ^= 54;
      this._inner.update(f);
      for (var w = 0; w < f.length; w++) f[w] ^= 106;
      this._outer.update(f),
        be.isSerializableHash(this._inner) &&
          be.isSerializableHash(this._outer) &&
    ...
    return (
      ...
      (t.prototype.finish = function (r) {
        return this._finished
          ? (this._outer.finish(r), this)
          : (this._inner.finish(r),
...
class qr {
  constructor() {
    ...
    r &&
      r.getRandomValues !== void 0 &&
      ((this._crypto = r), (this.isAvailable = !0), (this.isInstantiated = !0));
  }
  randomBytes(r) {
    ...
    for (let f = 0; f < n.length; f += _t)
      this._crypto.getRandomValues(
        n.subarray(f, f + Math.min(n.length - f, _t))
      );
    return n;
  }
}
...
class Wr {
  constructor() {
    if (
      ((this.isAvailable = !1), (this.isInstantiated = !1), typeof zr < "u")
    ) {
      const r = Tt;
      r &&
        r.randomBytes &&
  ...
  randomBytes(r) {
    ...
    for (let w = 0; w < f.length; w++) f[w] = n[w];
    return (0, Yr.wipe)(n), f;
  }
}
...
class Xr {
  constructor() {
    ...
    if (
      ((this._source = new Vr.NodeRandomSource()), this._source.isAvailable)
    ) {
      ...
      (h.prototype.update = function (c, d) {
        ...
        if (((this._bytesHashed += d), this._bufferLength > 0)) {
          for (; this._bufferLength < this.blockSize && d > 0; )
            (this._buffer[this._bufferLength++] = c[l++]), d--;
      ...
      (h.prototype.finish = function (c) {
        if (!this._finished) {
          var d = this._bytesHashed,
            ...
            _ = d % 64 < 56 ? 64 : 128;
          this._buffer[l] = 128;
          for (var v = l + 1; v < _ - 8; v++) this._buffer[v] = 0;
...
(function (t) {
  ...
  function f(a) {
    ...
    if (a) for (let u = 0; u < a.length; u++) o[u] = a[u];
    return o;
  }
  ...
  function U(a) {
    ...
    for (let u = 0; u < 16; u++) {
      let e = a[u] + o + 65535;
      (o = Math.floor(e / 65536)), (a[u] = e - o * 65536);
    }
    a[0] += o - 1 + 37 * (o - 1);
  }
  function h(a, o, u) {
  ...
  function c(a, o) {
    ...
    for (let i = 0; i < 2; i++) {
      u[0] = e[0] - 65517;
      for (let p = 1; p < 15; p++)
        (u[p] = e[p] - 65535 - ((u[p - 1] >> 16) & 1)), (u[p - 1] &= 65535);
      u[15] = e[15] - 32767 - ((u[14] >> 16) & 1);
      const y = (u[15] >> 16) & 1;
      (u[14] &= 65535), h(e, u, 1 - y);
    }
    for (let i = 0; i < 16; i++)
      (a[2 * i] = e[i] & 255), (a[2 * i + 1] = e[i] >> 8);
  }
  function d(a, o) {
    for (let u = 0; u < 16; u++) a[u] = o[2 * u] + (o[2 * u + 1] << 8);
    a[15] &= 32767;
  }
  function l(a, o, u) {
    for (let e = 0; e < 16; e++) a[e] = o[e] + u[e];
  }
  function E(a, o, u) {
    for (let e = 0; e < 16; e++) a[e] = o[e] - u[e];
  }
  ...
  function v(a, o) {
    const u = f();
    for (let e = 0; e < 16; e++) u[e] = o[e];
    for (let e = 253; e >= 0; e--) _(u, u), e !== 2 && e !== 4 && b(u, u, o);
    for (let e = 0; e < 16; e++) a[e] = u[e];
  }
  function C(a, o) {
    const u = new Uint8Array(32),
      ...
      M = f(),
      j = f();
    for (let m = 0; m < 31; m++) u[m] = a[m];
    (u[31] = (a[31] & 127) | 64), (u[0] &= 248), d(e, o);
    for (let m = 0; m < 16; m++) y[m] = e[m];
    i[0] = F[0] = 1;
    for (let m = 254; m >= 0; --m) {
      const N = (u[m >>> 3] >>> (m & 7)) & 1;
      h(i, y, N),
  ...
  function O(a) {
    ...
    return { publicKey: g(o), secretKey: o };
  }
  t.generateKeyPairFromSeed = O;
  function s(a) {
    const o = (0, r.randomBytes)(32, a),
      u = O(o);
    return (0, n.wipe)(o), u;
  }
  t.generateKeyPair = s;
  function D(a, o, u = !1) {
    ...
    if (u) {
      let i = 0;
      for (let y = 0; y < e.length; y++) i |= e[y];
...
function Zr(t, r) {
  ...
  for (var n = new Uint8Array(256), f = 0; f < n.length; f++) n[f] = 255;
  for (var w = 0; w < t.length; w++) {
    var S = t.charAt(w),
      U = S.charCodeAt(0);
    if (n[U] !== 255) throw new TypeError(S + " is ambiguous");
    n[U] = w;
  }
  var h = t.length,
    c = t.charAt(0),
  ...
  function E(v) {
    if (
      (v instanceof Uint8Array ||
        (ArrayBuffer.isView(v)
          ...
          : Array.isArray(v) && (v = Uint8Array.from(v))),
      !(v instanceof Uint8Array))
    )
    ...
    for (var D = ((s - O) * l + 1) >>> 0, a = new Uint8Array(D); O !== s; ) {
      for (
        ...
        (o += (256 * a[e]) >>> 0), (a[e] = o % h >>> 0), (o = (o / h) >>> 0);
      if (o !== 0) throw new Error("Non-zero carry");
      (g = u), O++;
    }
    for (var i = D - g; i !== D && a[i] === 0; ) i++;
    for (var y = c.repeat(C); i < D; ++i) y += t.charAt(a[i]);
    return y;
  }
  function b(v) {
    ...
    var C = 0;
    if (v[C] !== " ") {
      for (var g = 0, O = 0; v[C] === c; ) g++, C++;
      for (
        var s = ((v.length - C) * d + 1) >>> 0, D = new Uint8Array(s);
        v[C];

      ) {
        var a = n[v.charCodeAt(C)];
        if (a === 255) return;
        for (var o = 0, u = s - 1; (a !== 0 || o < O) && u !== -1; u--, o++)
          (a += (h * D[u]) >>> 0),
            (D[u] = a % 256 >>> 0),
            (a = (a / 256) >>> 0);
  ...
  return { encode: E, decodeUnsafe: b, decode: _ };
}
var kr = Zr,
  en = kr;
const tn = (t) => {
...
class an {
  constructor(r, n, f) {
    (this.name = r), (this.prefix = n), (this.baseEncode = f);
  }
  encode(r) {
...
class un {
  constructor(r, n, f) {
    ...
    (this.prefixCodePoint = n.codePointAt(0)), (this.baseDecode = f);
  }
  decode(r) {
    if (typeof r == "string") {
      if (r.codePointAt(0) !== this.prefixCodePoint)
        throw Error(
          `Unable to decode multibase string ${JSON.stringify(r)}, ${
            this.name
...
const He = ({ name: t, prefix: r, encode: n, decode: f }) => new fn(t, r, n, f),
  Ne = ({ prefix: t, name: r, alphabet: n }) => {
    ...
    return He({ prefix: t, name: r, encode: f, decode: (S) => tn(w(S)) });
  },
  hn = (t, r, n, f) => {
    const w = {};
    for (let l = 0; l < r.length; ++l) w[r[l]] = l;
    let S = t.length;
    for (; t[S - 1] === "="; ) --S;
    ...
    for (let l = 0; l < S; ++l) {
      const E = w[t[l]];
      if (E === void 0) throw new SyntaxError(`Non-${f} character`);
      (c = (c << n) | E),
        (h += n),
        h >= 8 && ((h -= 8), (U[d++] = 255 & (c >> h)));
    }
  ...
  sn = (t, r, n) => {
    ...
    for (let c = 0; c < t.length; ++c)
      for (h = (h << 8) | t[c], U += 8; U > n; )
        (U -= n), (S += r[w & (h >> U)]);
    if ((U && (S += r[w & (h << (n - U))]), f))
      for (; (S.length * n) & 7; ) S += "=";
    return S;
  },
  Z = ({ name: t, prefix: r, bitsPerChar: n, alphabet: f }) =>
    He({
      prefix: r,
      name: t,
      encode(w) {
  ...
  $n = Object.freeze(
    Object.defineProperty(
      { __proto__: null, identity: cn },
      Symbol.toStringTag,
      { value: "Module" }
    )
  ),
  Dn = Z({ prefix: "0", name: "base2", alphabet: "01", bitsPerChar: 1 }),
  qn = Object.freeze(
    Object.defineProperty({ __proto__: null, base2: Dn }, Symbol.toStringTag, {
      value: "Module",
    })
  ),
  ln = Z({ prefix: "7", name: "base8", alphabet: "01234567", bitsPerChar: 3 }),
  zn = Object.freeze(
    Object.defineProperty({ __proto__: null, base8: ln }, Symbol.toStringTag, {
      value: "Module",
    })
  ),
  _n = Ne({ prefix: "9", name: "base10", alphabet: "0123456789" }),
  Yn = Object.freeze(
    Object.defineProperty({ __proto__: null, base10: _n }, Symbol.toStringTag, {
      value: "Module",
    })
  ),
  dn = Z({
  ...
  Wn = Object.freeze(
    Object.defineProperty(
      { __proto__: null, base16: dn, base16upper: En },
      Symbol.toStringTag,
      { value: "Module" }
    )
  ),
  ...
  Vn = Object.freeze(
    Object.defineProperty(
      { __proto__: null, base36: An, base36upper: Un },
      Symbol.toStringTag,
      { value: "Module" }
    )
  ),
  ...
  Xn = Object.freeze(
    Object.defineProperty(
      { __proto__: null, base58btc: On, base58flickr: Fn },
      Symbol.toStringTag,
      { value: "Module" }
    )
  ),
  ...
  Bn = Nt.reduce((t, r, n) => ((t[n] = r), t), []),
  xn = Nt.reduce((t, r, n) => ((t[r.codePointAt(0)] = n), t), []);
function jn(t) {
  return t.reduce((r, n) => ((r += Bn[n]), r), "");
}
function Rn(t) {
  const r = [];
  for (const n of t) {
    const f = xn[n.codePointAt(0)];
    if (f === void 0) throw new Error(`Non-base256emoji character: ${n}`);
    r.push(f);
  }
  return new Uint8Array(r);
}
const In = He({ prefix: "🚀", name: "base256emoji", encode: jn, decode: Rn }),
  Qn = Object.freeze(
    Object.defineProperty(
      { __proto__: null, base256emoji: In },
      Symbol.toStringTag,
      { value: "Module" }
    )
  );
